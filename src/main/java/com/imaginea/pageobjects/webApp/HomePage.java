...
public class HomePage extends UIUtility {
	...
	private By optionList= By.cssSelector(".subCatBlock[style='display: block;']>a");
	...
	public void clickSubSubCategory(String subCategory){
		clickSubElementFromList(optionList,subCategory);
		waitForPageLoad();
		waitforAjaxLoading();
	}
}
